...
DEVICES = [
    {"brand": "motorola", "model": "moto g(60)", "os_version": "12", "dpi": 400, "w": 1080, "h": 2225},
    {"brand": "samsung", "model": "SM-M315F", "os_version": "13", "dpi": 420, "w": 1080, "h": 2400},
    {"brand": "samsung", "model": "SM-A546E", "os_version": "14", "dpi": 450, "w": 1080, "h": 2340},
    {"brand": "xiaomi", "model": "M2010J19SI", "os_version": "12", "dpi": 440, "w": 1080, "h": 2400},
    {"brand": "realme", "model": "RMX3363", "os_version": "13", "dpi": 480, "w": 1080, "h": 2400},
    {"brand": "vivo", "model": "V2130", "os_version": "13", "dpi": 440, "w": 1080, "h": 2376},
]
...
def search_products(query, page=1, limit=20):
    ...
    headers = {
        ...
        "user-agent": f"Dalvik/2.1.0 (Linux; U; Android {dev['os_version']}; {dev['model']} Build/) Cronet",
        ...
        if resp.status_code == 200:
            ...
            for c in catalogs:
                ...
                products.append({
                    ...
                    "price": int(price),
                    "mrp": int(mrp),
                    "rating": round(float(rating), 1) if rating else 4.0,
                    "image": str(image)
                })
...
class APIHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if parsed.path == '/api/search':
            ...
            self._json({"ok": True, "accounts": load_accounts().get(user_id, [])})
    ...
    def do_POST(self):
        ...
        if parsed.path == '/api/send_otp':
            self._json({"ok": True, "message": "OTP sent (demo - koi bhi 4 digit)"})
